...
export async function POST(req: NextRequest) {
  try {
    ...
    await transporter.sendMail({
      from: `"Aalpha Gir Gay Gaushala Website" <${process.env.SMTP_USER}>`,
      ...
      html: `
        <div style="font-family: Georgia, serif; max-width: 600px; margin: 0 auto; background: #FEFAE0; border-radius: 16px; overflow: hidden;">
          <div style="background: linear-gradient(135deg, #2D6A4F, #40916C); padding: 30px; text-align: center;">
            <h1 style="color: #FEFAE0; margin: 0; font-size: 28px;">Aalpha Gir Gay Gaushala</h1>
    ...
    await transporter.sendMail({
      from: `"Aalpha Gir Gay Gaushala" <${process.env.SMTP_USER}>`,
      to: email,
      subject: `Thank you for your inquiry, ${name.split(" ")[0]}! — Aalpha Gir Gay Gaushala`,
      html: `
        <div style="font-family: Georgia, serif; max-width: 600px; margin: 0 auto; background: #FEFAE0; border-radius: 16px; overflow: hidden;">
          <div style="background: linear-gradient(135deg, #2D6A4F, #40916C); padding: 30px; text-align: center;">
            <h1 style="color: #FEFAE0; margin: 0; font-size: 28px;">Aalpha Gir Gay Gaushala</h1>
            <p style="color: #D4A017; margin: 5px 0 0; font-size: 13px; letter-spacing: 2px; text-transform: uppercase;">Gay Gaushala</p>
          </div>
          <div style="padding: 30px;">
            ...
            <p style="color: #6B4226; line-height: 1.7; margin: 0 0 15px;">
              Thank you for reaching out to Aalpha Gir Gay Gaushala! We have received your inquiry
            ...
            <p style="color: #6B4226; line-height: 1.7; margin: 0 0 20px;">
              We are committed to providing you with the finest answers about our pure Aalpha Gir Gay Gaushala
            ...
            <div style="background: #F8F4E3; border-radius: 12px; padding: 18px; border-left: 4px solid #D4A017;">
              <p style="color: #3B2314; font-weight: bold; margin: 0 0 8px;">Aalpha Gir Gay Gaushala</p>
              <p style="color: #6B4226; font-size: 14px; margin: 0 0 4px;">📍 Gujarat, India</p>
              <p style="color: #6B4226; font-size: 14px; margin: 0 0 4px;">📞 +91 75678 49349</p>
              <p style="color: #6B4226; font-size: 14px; margin: 0;">🌿 Est. 15 March 2022</p>
            </div>
            <p style="color: #3B2314; margin: 20px 0 0; font-style: italic;">
              Warm regards,<br />
              <strong>Team Aalpha Gir Gay Gaushala</strong><br />
