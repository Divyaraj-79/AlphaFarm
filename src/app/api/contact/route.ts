...
export async function POST(req: NextRequest) {
  try {
    ...
    await transporter.sendMail({
      from: `"Aalpha Farm Website" <${process.env.SMTP_USER}>`,
      ...
      html: `
        <div style="font-family: Georgia, serif; max-width: 600px; margin: 0 auto; background: #FEFAE0; border-radius: 16px; overflow: hidden;">
          <div style="background: linear-gradient(135deg, #2D6A4F, #40916C); padding: 30px; text-align: center;">
            <h1 style="color: #FEFAE0; margin: 0; font-size: 28px;">Aalpha Farm</h1>
    ...
    await transporter.sendMail({
      from: `"Aalpha Farm Gaushala" <${process.env.SMTP_USER}>`,
      to: email,
      subject: `Thank you for your inquiry, ${name.split(" ")[0]}! — Aalpha Farm`,
      html: `
        <div style="font-family: Georgia, serif; max-width: 600px; margin: 0 auto; background: #FEFAE0; border-radius: 16px; overflow: hidden;">
          <div style="background: linear-gradient(135deg, #2D6A4F, #40916C); padding: 30px; text-align: center;">
            <h1 style="color: #FEFAE0; margin: 0; font-size: 28px;">Aalpha Farm</h1>
          ...
          <div style="padding: 30px;">
            ...
            <p style="color: #6B4226; line-height: 1.7; margin: 0 0 15px;">
              Thank you for reaching out to Aalpha Farm Gaushala! We have received your inquiry
            ...
            <div style="background: #F8F4E3; border-radius: 12px; padding: 18px; border-left: 4px solid #D4A017;">
              <p style="color: #3B2314; font-weight: bold; margin: 0 0 8px;">Aalpha Farm Gaushala</p>
            ...
            <p style="color: #3B2314; margin: 20px 0 0; font-style: italic;">
              Warm regards,<br />
              <strong>Team Aalpha Farm</strong><br />
